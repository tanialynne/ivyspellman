...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      type: "book",
      url: `/books/${book.slug}`,
      // Per-book share card so a shared book link previews with THAT cover.
      // Cards are generated by scripts/generate-og.mjs — re-run after adding a book.
      images: [
        {
          url: `/og/${book.slug}.jpg`,
          width: 1200,
          height: 630,
          alt: `${book.title} — a cozy witch romantic fantasy by Ivy Spellman`,
        },
      ],
    },
    twitter: {
